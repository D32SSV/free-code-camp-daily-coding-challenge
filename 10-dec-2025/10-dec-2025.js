...
Waiting:2. parseBold("__This is also bold__") should return "<b>This is also bold</b>".
Waiting:3. parseBold("**This is not bold **") should return "**This is not bold **".
Waiting:4. parseBold("__ This is also not bold__") should return "__ This is also not bold__".
Waiting:5. parseBold("The **quick** brown fox __jumps__ over the **lazy** dog.") should return "The <b>quick</b> brown fox <b>jumps</b> over the <b>lazy</b> dog.".
*/
